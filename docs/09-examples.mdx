...
```toml
[editors.files]
"neovim" = { target = "~/.config/nvim", type = "symbolic", if = "(is_executable \"nvim\")" }
"vim" = { target = "~/.vimrc", type = "symbolic", if = "(is_executable \"vim\")" }

[terminals.files]
"alacritty" = { target = "~/.config/alacritty", type = "symbolic", if = "(is_executable \"alacritty\")" }
"kitty" = { target = "~/.config/kitty", type = "symbolic", if = "(is_executable \"kitty\")" }
```
...
"linux-only" = { target = "~/.config/linux-only", type = "symbolic", if = "dotter.linux" }
```
